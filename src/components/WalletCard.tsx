      ...
      <div className="p-4">
        <div className="flex justify-between items-start mb-4">
          <div>
            ...
            <p className="text-xs text-blue-400 glow-text">Manage rewards</p>
          </div>
        ...
        <div className="bg-gradient-to-r from-bharat-600 to-bharat-800 dark:from-bharat-700 dark:to-bharat-900 rounded-lg p-4 text-white mb-4">
          <div className="flex justify-between items-center mb-1">
            <p className="text-xs font-medium text-blue-200 glow-text">Available Balance</p>
          </div>
        ...
        <div className="mb-4">
          <div className="flex justify-between items-center mb-2">
            <p className="text-xs font-medium text-blue-400 glow-text">Cashback Points</p>
          ...
          <div className="flex justify-between text-xs text-blue-300 glow-text">
            <p>0</p>
            <p>100 pts for ₹100</p>
          </div>
        </div>
